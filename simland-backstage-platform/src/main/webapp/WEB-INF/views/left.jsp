...
<div id="left">
	   ...
	   <div class="menuShow">
		   ...
		   <div class="left_tree">
				<div class="tree_text">
				     <li class="tree_li"> <img src="${pageContext.request.contextPath}/images/list_img.gif" /> <a class="list_img" href="${pageContext.request.contextPath}/purview/powerList">新增商品</a></li>
				     <li class="tree_li"> <img src="${pageContext.request.contextPath}/images/list_img.gif" /> <a class="list_img" href="${pageContext.request.contextPath}/purview/powerList">商品列表</a></li>	
				</div>
		   </div>
		   <div id="tree_down"></div>
	   </div>
