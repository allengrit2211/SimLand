package com.simland.backstage.listener;
...
public class ServletListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		try {
			...
			ICategoryPropertiesService categoryPropertiesService = (ICategoryPropertiesService) context
					.getBean("categoryPropertiesService");
